...
$sql = "INSERT INTO usedcar_detail (usedcar_autobrandid, usedcar_name, usedcar_detail, usedcar_price,
  usedcar_yprice, usedcar_class, usedcar_register, usedcar_mileage, usedcar_colour, usedcar_add, usedcar_author, usedcar_tal, usedcar_sub, usedcar_display, usedcar_video, usedcar_pic1, usedcar_pic2, usedcar_pic3, usedcar_pic4, usedcar_pic5, usedcar_pic6, usedcar_pic7, usedcar_pic8, usedcar_pic9, usedcar_pic10)
VALUES ('$usedcar_autobrandid', '$usedcar_name', '$usedcar_detail', '$usedcar_price', '$usedcar_yprice',
  '$usedcar_class', '$usedcar_register', '$usedcar_mileage', '$usedcar_colour','$usedcar_add', '$usedcar_author', '$usedcar_tal', '$usedcar_sub', '$usedcar_display','$usedcar_video',
